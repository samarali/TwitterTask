...
+ (instancetype)twitterOAuthWithConsumerKey:(NSString *)consumerKey
                              consumerSecret:(NSString *)consumerSecret {
    
    STTwitterOAuth *to = [[STTwitterOAuth alloc] init];
    
    to.oauthConsumerName = nil;
...
+ (instancetype)twitterOAuthWithConsumerKey:(NSString *)consumerKey
    ...
    STTwitterOAuth *to = [self twitterOAuthWithConsumerKey:consumerKey consumerSecret:consumerSecret];
